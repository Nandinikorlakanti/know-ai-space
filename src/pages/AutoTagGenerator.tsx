...
import { Tags, Home, LogOut, User } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#1A1D29] to-[#0F1419] text-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-300">Automatically generate relevant tags for your documents to improve organization</p>
        </div>
          ...
          <CardContent>
            <Select value={selectedWorkspace} onValueChange={setSelectedWorkspace}>
              <SelectTrigger className="bg-white/5 border-white/20 text-white">
                <SelectValue placeholder="Choose a workspace to generate tags" />
              </SelectTrigger>
              <SelectContent>
            ...
            {selectedWorkspace && (
              <div className="mt-4 p-4 bg-white/5 rounded-lg">
                <p className="text-gray-300">Auto Tag Generator is coming soon. This will automatically analyze your documents and generate relevant tags to improve organization and searchability.</p>
              </div>
            )}
          </CardContent>
        </Card>
